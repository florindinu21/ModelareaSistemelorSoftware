...
namespace QA.Infrastructure.Controllers.InsertNewQuestionController
{
    public class InsertNewQuestionCommandHandler : BaseController<InsertNewQuestionCommand>
    {
